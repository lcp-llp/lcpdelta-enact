...
class DPSHelperAsync:
    ...
    def _initialise(self):
        ...
        self.signalr_client.on_error(lambda e: print("SignalR error:", e))
    ...
    async def start(self):
        ...
        await self.signalr_client.hub_connection.run()
    ...
    def _on_close(self):
        ...
        if not self.signalr_client.is_running():
