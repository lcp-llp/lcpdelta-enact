...
class APIHelper(APIHelperBase):
    ...
    def get_ancillary_contract_data(self, ancillary_contract_type : str, option_one : Union[str, int], option_two : Union[int, str] = None) -> pd.DataFrame:
        ...
        response = self.post_request(endpoint, request_details)
        dx_and_balancing_reserve_contract_types = ['DynamicContainmentEfa', 'DynamicContainmentEfaHF', 'DynamicModerationLF',
                                                   'DynamicModerationHF', 'DynamicRegulationLF', 'DynamicRegulationHF',
                                                   'NegativeBalancingReserve', 'PositiveBalancingReserve']
